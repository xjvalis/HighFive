...
export default function Privacy() {
  return (
    <div className="max-w-2xl mx-auto pb-16 pt-2" style={{ fontFamily: "'Outfit', system-ui, sans-serif" }}>
      <Link to="/" className="flex items-center gap-2 mb-4 transition-colors w-fit" style={{ font: "300 12.5px 'Outfit', sans-serif", color: 'var(--sv-meta)' }}>
      ...
      <div style={{ background: 'var(--sv-surface)', border: '1px solid var(--sv-hairline)', borderRadius: 'var(--sv-r-card)', padding: '22px 22px' }} className="space-y-5">
        <div>
          <h1 style={{ font: "500 20px 'Outfit', sans-serif", letterSpacing: '-0.03em', color: 'var(--sv-ink)', marginBottom: 4 }}>Zásady ochrany osobních údajů</h1>
          <p style={{ font: "300 12px 'Outfit', sans-serif", color: 'var(--sv-meta)' }}>Platné od: 1. 8. 2026</p>
        </div>

        <section className="space-y-2">
          <h2 style={{ font: "500 15.5px 'Outfit', sans-serif", color: 'var(--sv-ink)' }}>1. Kdo jsme</h2>
        ...
        <section className="space-y-2">
          <h2 style={{ font: "500 15.5px 'Outfit', sans-serif", color: 'var(--sv-ink)' }}>2. Jaké údaje zpracováváme</h2>
          <ul className="list-disc pl-5 space-y-1" style={{ font: "300 13.5px 'Outfit', sans-serif", color: 'var(--sv-ink-soft)', lineHeight: 1.6 }}>
        ...
        <section className="space-y-2">
          <h2 style={{ font: "500 15.5px 'Outfit', sans-serif", color: 'var(--sv-ink)' }}>3. Proč údaje zpracováváme</h2>
          <ul className="list-disc pl-5 space-y-1" style={{ font: "300 13.5px 'Outfit', sans-serif", color: 'var(--sv-ink-soft)', lineHeight: 1.6 }}>
        ...
        <section className="space-y-2">
          <h2 style={{ font: "500 15.5px 'Outfit', sans-serif", color: 'var(--sv-ink)' }}>4. Právní základ zpracování</h2>
          <p style={{ font: "300 13.5px 'Outfit', sans-serif", color: 'var(--sv-ink-soft)', lineHeight: 1.6 }}>
        ...
        <section className="space-y-2">
          <h2 style={{ font: "500 15.5px 'Outfit', sans-serif", color: 'var(--sv-ink)' }}>5. Komu údaje předáváme</h2>
          <p style={{ font: "300 13.5px 'Outfit', sans-serif", color: 'var(--sv-ink-soft)', lineHeight: 1.6 }}>
        ...
        <section className="space-y-2">
          <h2 style={{ font: "500 15.5px 'Outfit', sans-serif", color: 'var(--sv-ink)' }}>6. Doba uchovávání</h2>
          <p style={{ font: "300 13.5px 'Outfit', sans-serif", color: 'var(--sv-ink-soft)', lineHeight: 1.6 }}>
        ...
        <section className="space-y-2">
          <h2 style={{ font: "500 15.5px 'Outfit', sans-serif", color: 'var(--sv-ink)' }}>7. Vaše práva</h2>
          <p style={{ font: "300 13.5px 'Outfit', sans-serif", color: 'var(--sv-ink-soft)', lineHeight: 1.6 }}>Podle GDPR máte právo:</p>
          <ul className="list-disc pl-5 space-y-1" style={{ font: "300 13.5px 'Outfit', sans-serif", color: 'var(--sv-ink-soft)', lineHeight: 1.6 }}>
        ...
        <section className="space-y-2">
          <h2 style={{ font: "500 15.5px 'Outfit', sans-serif", color: 'var(--sv-ink)' }}>8. Cookies a lokální úložiště</h2>
          <p style={{ font: "300 13.5px 'Outfit', sans-serif", color: 'var(--sv-ink-soft)', lineHeight: 1.6 }}>
        ...
        <section className="space-y-2">
          <h2 style={{ font: "500 15.5px 'Outfit', sans-serif", color: 'var(--sv-ink)' }}>9. Zabezpečení</h2>
          <p style={{ font: "300 13.5px 'Outfit', sans-serif", color: 'var(--sv-ink-soft)', lineHeight: 1.6 }}>
        ...
        <section className="space-y-2">
          <h2 style={{ font: "500 15.5px 'Outfit', sans-serif", color: 'var(--sv-ink)' }}>10. Věkové omezení</h2>
          <p style={{ font: "300 13.5px 'Outfit', sans-serif", color: 'var(--sv-ink-soft)', lineHeight: 1.6 }}>
        ...
        <section className="space-y-2">
          <h2 style={{ font: "500 15.5px 'Outfit', sans-serif", color: 'var(--sv-ink)' }}>11. Změny těchto zásad</h2>
          <p style={{ font: "300 13.5px 'Outfit', sans-serif", color: 'var(--sv-ink-soft)', lineHeight: 1.6 }}>

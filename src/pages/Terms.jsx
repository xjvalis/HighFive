  ...
  return (
    <div className="max-w-2xl mx-auto pb-16 pt-2" style={{ fontFamily: "'Outfit', system-ui, sans-serif" }}>
      ...
      <div style={{ background: 'var(--sv-surface)', border: '1px solid var(--sv-hairline)', borderRadius: 'var(--sv-r-card)', padding: '22px 22px' }} className="space-y-5">
        <div>
          <h1 style={{ font: "500 20px 'Outfit', sans-serif", letterSpacing: '-0.03em', color: 'var(--sv-ink)', marginBottom: 4 }}>Podmínky používání</h1>
          <p style={{ font: "300 12px 'Outfit', sans-serif", color: 'var(--sv-meta)' }}>Platné od: 1. 8. 2026</p>
        </div>

        <section className="space-y-2">
          <h2 style={{ font: "500 15.5px 'Outfit', sans-serif", color: 'var(--sv-ink)' }}>1. Úvod</h2>
        ...
        <section className="space-y-2">
          <h2 style={{ font: "500 15.5px 'Outfit', sans-serif", color: 'var(--sv-ink)' }}>2. Co Služba je (a co není)</h2>
          <p style={{ font: "300 13.5px 'Outfit', sans-serif", color: 'var(--sv-ink-soft)', lineHeight: 1.6 }}>
        ...
        <section className="space-y-2">
          <h2 style={{ font: "500 15.5px 'Outfit', sans-serif", color: 'var(--sv-ink)' }}>3. Registrace a účet</h2>
        ...
        <section className="space-y-2">
          <h2 style={{ font: "500 15.5px 'Outfit', sans-serif", color: 'var(--sv-ink)' }}>4. Pravidla chování</h2>
          <p style={{ font: "300 13.5px 'Outfit', sans-serif", color: 'var(--sv-ink-soft)', lineHeight: 1.6 }}>Při používání Služby je zakázáno:</p>
          <ul className="list-disc pl-5 space-y-1" style={{ font: "300 13.5px 'Outfit', sans-serif", color: 'var(--sv-ink-soft)', lineHeight: 1.6 }}>
        ...
        <section className="space-y-2">
          <h2 style={{ font: "500 15.5px 'Outfit', sans-serif", color: 'var(--sv-ink)' }}>5. Bezpečnost při osobních setkáních</h2>
          <p style={{ font: "300 13.5px 'Outfit', sans-serif", color: 'var(--sv-ink-soft)', lineHeight: 1.6 }}>
        ...
        <section className="space-y-2">
          <h2 style={{ font: "500 15.5px 'Outfit', sans-serif", color: 'var(--sv-ink)' }}>6. Obsah vytvořený uživateli</h2>
          <p style={{ font: "300 13.5px 'Outfit', sans-serif", color: 'var(--sv-ink-soft)', lineHeight: 1.6 }}>
        ...
        <section className="space-y-2">
          <h2 style={{ font: "500 15.5px 'Outfit', sans-serif", color: 'var(--sv-ink)' }}>7. Placené tarify</h2>
          <p style={{ font: "300 13.5px 'Outfit', sans-serif", color: 'var(--sv-ink-soft)', lineHeight: 1.6 }}>
        ...
        <section className="space-y-2">
          <h2 style={{ font: "500 15.5px 'Outfit', sans-serif", color: 'var(--sv-ink)' }}>8. Ukončení účtu</h2>
          <p style={{ font: "300 13.5px 'Outfit', sans-serif", color: 'var(--sv-ink-soft)', lineHeight: 1.6 }}>
        ...
        <section className="space-y-2">
          <h2 style={{ font: "500 15.5px 'Outfit', sans-serif", color: 'var(--sv-ink)' }}>9. Omezení odpovědnosti</h2>
          <p style={{ font: "300 13.5px 'Outfit', sans-serif", color: 'var(--sv-ink-soft)', lineHeight: 1.6 }}>
        ...
        <section className="space-y-2">
          <h2 style={{ font: "500 15.5px 'Outfit', sans-serif", color: 'var(--sv-ink)' }}>10. Změny podmínek</h2>
          <p style={{ font: "300 13.5px 'Outfit', sans-serif", color: 'var(--sv-ink-soft)', lineHeight: 1.6 }}>
        ...
        <section className="space-y-2">
          <h2 style={{ font: "500 15.5px 'Outfit', sans-serif", color: 'var(--sv-ink)' }}>11. Rozhodné právo</h2>
          <p style={{ font: "300 13.5px 'Outfit', sans-serif", color: 'var(--sv-ink-soft)', lineHeight: 1.6 }}>

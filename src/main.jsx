...
function ErrorFallback() {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '24px', textAlign: 'center', fontFamily: "'Outfit', system-ui, sans-serif", background: '#FDFCFA' }}>
      ...
      <h1 style={{ fontSize: '21px', fontWeight: 500, marginBottom: '8px', color: '#3A343F' }}>
        {lang === 'cs' ? 'Něco se pokazilo' : 'Something went wrong'}
      </h1>
      <p style={{ fontSize: '15px', color: '#8C8790', marginBottom: '20px', maxWidth: '320px', fontWeight: 300 }}>
      ...
      <button
        ...
        style={{ background: '#FFE7C2', color: '#5C4A1E', border: 'none', borderRadius: '999px', padding: '10px 20px', fontSize: '15px', fontWeight: 500, cursor: 'pointer' }}
      >

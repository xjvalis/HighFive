  ...
  return (
    <div style={{ ...svCard, padding: 18 }}>
      <div className="flex items-center justify-between" style={{ marginBottom: 14 }}>
        ...
        <span style={{ font: "400 11px 'IBM Plex Mono', monospace", color: 'var(--sv-meta)' }}>{earned.length}/{BADGES.length}</span>
      </div>
      <TooltipProvider>
              ...
              <Tooltip key={badge.id}>
                <TooltipTrigger asChild>
                  ...
                  >
                    ...
                    <span className="text-center leading-tight" style={{ font: "500 10.5px 'Outfit', sans-serif", color: 'var(--sv-ink-soft)' }}>{label}</span>
                  </div>
                </TooltipTrigger>
                <TooltipContent>

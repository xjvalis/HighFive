...
export const svPageTitle = { font: "500 20px 'Outfit', sans-serif", letterSpacing: '-0.03em', color: 'var(--sv-ink)' };
export const svSubtitle = { font: "300 13.5px 'Outfit', sans-serif", color: 'var(--sv-meta)' };
export const svMeta = { font: "300 12.5px 'Outfit', sans-serif", color: 'var(--sv-meta)' };
export const svSectionLabel = { font: "500 10.5px 'IBM Plex Mono', monospace", letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--sv-meta)' };
...
export const svField = {
  ...
  borderRadius: 10, boxShadow: 'none', font: "300 14px 'Outfit', sans-serif", color: 'var(--sv-ink)',
};
export const svLabel = { display: 'block', marginBottom: 6, font: "500 13.5px 'Outfit', sans-serif", color: 'var(--sv-ink-soft)' };

...
function SplashScreen() {
  ...
  return (
    <div style={{
      ...
      <p style={{ font: "300 14px 'Outfit', sans-serif", color: 'var(--sv-meta)', margin: '0 0 2px 0' }}>
        {lang === 'cs' ? 'Být' : 'Be'}
      </p>
      <h1 style={{ font: "500 21px 'Outfit', sans-serif", letterSpacing: '-0.03em', margin: 0, color: 'var(--sv-ink)' }}>
        Spoluvíc
      </h1>
    </div>
  );
